...
export const validateShortcutKey = (key: string): boolean => {
  ...
  // FIXED: Added "super" so Linux Cosmic accepts it
  ...
  const validKeys = [
    ...
    "space","return","enter","tab","backspace","delete","esc","escape",
    "up","down","left","right","backslash","slash","comma","period",
    "minus","equal","plus","bracketleft","bracketright","semicolon",
    "quote","grave",
  ];
